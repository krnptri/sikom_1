			...
			<div class="sticky">
				<aside class="app-sidebar sidebar-scroll">
					...
					<div class="main-sidemenu">
							...
							<div class="app-sidebar__user">
								<div class="dropdown user-pro-body text-center">
									...
									<div class="user-info">
										...
										<span class="text-muted app-sidebar__user-name text-sm">{{auth()->user()->nama_lengkap }}</span>
									</div>
								</div>
							</div>
						</div>
						...
						<ul class="side-menu ">
							<li class="slide">
								<a class="side-menu__item {{ request()->is('peminjaman')? 'active': '' }}" href="{{ route('peminjaman.index') }}"><i class="side-menu__icon ion-md-filing"></i><span class="side-menu__label">Peminjaman</span></a>
							</li>
						</ul>
						<div class="slide-right" id="slide-right"><svg xmlns="http://www.w3.org/2000/svg" fill="#7b8191" width="24" height="24" viewBox="0 0 24 24"><path d="M10.707 17.707 16.414 12l-5.707-5.707-1.414 1.414L13.586 12l-4.293 4.293z"/></svg></div>
						<div class="slide-left disabled" id="slide-left"><svg xmlns="http://www.w3.org/2000/svg" fill="#7b8191" width="24" height="24" viewBox="0 0 24 24"><path d="M13.293 6.293 7.586 12l5.707 5.707 1.414-1.414L10.414 12l4.293-4.293z"/></svg></div>
						<ul class="side-menu ">
							<li class="slide">
								<a class="side-menu__item {{ request()->is('peminjaman')? 'active': '' }}" href="{{ route('ulasan_buku.index') }}"><i class="side-menu__icon ion-md-filing"></i><span class="side-menu__label">Ulasan Buku</span></a>
							</li>
						</ul>
						<div class="slide-right" id="slide-right"><svg xmlns="http://www.w3.org/2000/svg" fill="#7b8191" width="24" height="24" viewBox="0 0 24 24"><path d="M10.707 17.707 16.414 12l-5.707-5.707-1.414 1.414L13.586 12l-4.293 4.293z"/></svg></div>
					</div>
